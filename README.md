<h3><h2>Результаты прохождения тестов и отчёт о выполнении лабораторных работ:</h2>
	<ul>
		<li>Тест "Инновациии"- <b>68%</b></li>
		<li>Тест "Управление проектами"- <b>82%</b></li>
	</ul>
	<a href="https://vanorro228.github.io">Страница с отчётом о выполнении лабораторных работ</a>
	</h3>
<h3><h2>В ходе работы над проектом были выполнены следующие задачи:</h2></em>
   <ul>
    <li>Была сформирована команда из четырех человек:
	    <ul><li><a href="https://github.com/vikakonovodova">Коноводова Виктория</a></li>
		    <li><a href="https://github.com/EgorTabolskii">Табольский Егор</a></li>
		    <li><a href="https://github.com/vanorro228">Титоренко Иван</a></li>
		    <li><a href="https://github.com/kyushkin">Юшкин Кирилл</a></li>
     </ul>
    </li>
    <li> Был разработан проект <a href="http://vanorro228.github.io/alex-foto">Сайт-визитка фотографа Александра Прокопенко</a></li>    
    <li> Отснят и смонтирован рекламный ролик для фотографа (он представлен на сайте)</li>
    <li> Была разработана <a href="http://vanorro228.github.io/presentation">презентация проекта</a></li>   
   </ul>
